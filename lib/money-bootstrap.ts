/**
 * DEMO ONLY — anonymized synthetic bootstrap for Money.xlsx-style migration.
 * Real personal workbooks must never be committed; keep them in gitignored data/.
 */
...
export type MoneySheetInventoryItem = {
  name: string;
  rows: number;
  columns: number;
...
export type MoneyBootstrapDataset = {
  ...
  currency: string;
  locale: string;
  sheetInventory: MoneySheetInventoryItem[];
  ...
  dashboardHints: {
    consolidatedAccountsCents: number;
    openBillsCents: number;
    nextRecurringWindowCents: number;
  };
};

/** Synthetic demo dataset shaped like a Money.xlsx migration — anonymized for public portfolio. */
export const moneyBootstrapDataset = {
  ...
  "sheetInventory": [
    ...
    },
    {
      ...
      "sampleHeaders": [
        ...
        "Nome da Conta:",
        "Valor",
        " *Março*\n\n Aurora: *R$ 566,25*\n - Music Class (4/10) R$ 160,00\n - Gym Club R$ 149,90\n - Phone Plan (2/12) R$ 256,35\n\n WalletPay: *R$ 53,50*\n - Kitchen Appliance (4/4) R$ 53,50\n\n  Aluguel: *R$ 601,83*\n Internet: *R$ 40,76*\n Appliance Plan: *R$ 50,67*\n\n *Total Março: R$ 1.313,01*",
        " *Abril*\n\n Aurora: *R$ 566,25*\n - Music Class (5/10) R$ 160,00\n - Gym Club R$ 149,90\n - Phone Plan (3/12) R$ 256,35\n\n WalletPay: *R$ 0,00*\n\n\n  Aluguel: *R$ 601,83*\n Internet: *R$ 40,76*\n Energia: *R$ 55,41*\n Appliance Plan: *R$ 50,67*\n\n *Total Abril: R$ 1.314,91*"
      ]
    },
    {
  ...
  "accounts": [
    ...
    },
    {
      ...
      "includeInNetWorth": true,
      "notes": "Reserva identificada como Invest Aporte."
    },
    {
      "name": "NuInvest",
      "institution": "Aurora",
      ...
      "includeInNetWorth": true,
      "notes": "Carteira de ações ligada ao ecossistema Aurora."
    },
    {
      "name": "CryptoX",
      "institution": "CryptoX",
  ...
  "cards": [
    {
      ...
      "closeDay": 18,
      "dueDay": 25,
      "settlementAccountName": "Aurora CC"
    },
    {
      "name": "Cartão WalletPay",
      "brand": "WalletPay",
      "network": "Visa",
      "limitAmountCents": 150000,
      "closeDay": 8,
      "dueDay": 15,
      "settlementAccountName": "WalletPay CC"
    }
  ],
  "recurring": [
    {
    ...
    },
    {
      ...
      "accountName": "WalletPay CC",
      "notes": "Compromisso fixo da aba Planner."
    },
    {
      "title": "Internet",
      "amountCents": 4076,
    ...
    },
    {
      ...
      "accountName": "WalletPay CC",
      "notes": "Parcela fixa destacada na aba Planner."
    }
  ],
  "cardBills": [
    {
      "cardSlug": "cartao-walletpay",
      "billMonth": "2026-03",
      "dueOn": "2026-03-15",
      "closesOn": "2026-03-08",
  ...
  "cardEntries": [
    ...
    },
    {
      "cardSlug": "cartao-walletpay",
      "dueOn": "2026-03-15",
      "description": "Kitchen Appliance (4/4)",
      "amountCents": 5350,
      "entryType": "recurring"
    },
    {
